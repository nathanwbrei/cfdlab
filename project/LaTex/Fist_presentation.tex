...
\begin{frame}
    ...
    \item Stream step,
    \item Collide step,
    \item Update flags and
    \item Boundary treatment
    \end{itemize}
    were parallelized with OpenMP. \\
    Function to calculate $f^{eq}$ was highly optimized with
    \begin{itemize}
    \item Vectorization
...
\begin{frame}
    ...
    \item For the biggest example (500x500x200)
    \begin{itemize}
    \item Each vtk file weights 651 MB
    \item It needs 13 GB of memory to make the calculations
    \end{itemize}
    \end{itemize}
\end{frame}
...
\begin{frame}
\frametitle{Two breaking dams}
\movie [width=7cm,height=5cm,duration=5s,poster]{}{collapse.mp4} 
\end{frame}

\begin{frame}
\frametitle{Inflow and obstacles}
\movie [width=7cm,height=5cm,duration=5s,poster]{}{inflow.mp4} 
\end{frame}

\begin{frame}
\frametitle{High-res breaking dam}
\movie [width=7cm,height=5cm,duration=5s,poster]{}{wall500100.mp4} 
\end{frame}
